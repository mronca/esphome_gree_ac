...
namespace protocol {
    ...
    static const uint8_t REPORT_FAN_SPD1_BYTE  = 4;
    static const uint8_t REPORT_FAN_SPD1_MASK  = 0b00001111;
    static const uint8_t REPORT_FAN_SPD1_POS   = 0;
    static const uint8_t REPORT_FAN_SPD2_BYTE  = 4;   // unused but keep for compatibility
    static const uint8_t REPORT_FAN_SPD2_MASK  = 0b00001111;
